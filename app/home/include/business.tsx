...
export default function HomeBusiness() {
  return (
    <section className="relative w-full py-12 md:py-20 bg-white overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-125 h-125 bg-[#00b14f]/5 blur-[150px] rounded-full pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {opportunities.map((opp, i) => (
            ...
            >
              ...
              {i === 1 ? (
                <>
                  <div className="absolute inset-0 bg-linear-to-tr from-[#050505] via-[#050505]/60 to-transparent opacity-90 group-hover:opacity-100 transition-opacity duration-500" />
